namespace PeinearyDevelopment.Framework.Filtering.Extensions
{
  ...
  public static class FilterBuilderOrExtensions
  {
    ...
    public static CompoundFilterBuilder<TFilterable> Or<TFilterable, TNumeric>(this SimpleFilterBuilder<TFilterable> simpleFilterBuilder, string propertyName, NumericFilterType filterType, TNumeric filterValue) where TFilterable : class, IFilterable
                                                                                                                                                                                                                   where TNumeric : struct
    {
        return simpleFilterBuilder.Or(new NumericCriterion<TFilterable, TNumeric>(propertyName, filterType, filterValue));
    }

    public static CompoundFilterBuilder<TFilterable> Or<TFilterable, TNumeric>(this SimpleFilterBuilder<TFilterable> simpleFilterBuilder, Expression<Func<TFilterable, TNumeric>> propertyNameExpression, SetFilterType filterType, IEnumerable<TNumeric> filterValue) where TFilterable : class, IFilterable
                                                                                                                                                                                                                                                                    where TNumeric : struct
    {
      return simpleFilterBuilder.Or(new NumericSetCriterion<TFilterable, TNumeric>(propertyNameExpression, filterType, filterValue));
    }
